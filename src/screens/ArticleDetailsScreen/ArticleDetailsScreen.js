...
import SelectBookmarksCollections from "../BookmarksScreen/components/SelectBookmarksCollections";
      ...
      headerRight: () => (
        <View style={{ flexDirection: "row", alignItems: "center", gap: 24 }}>
          ...
          <Pressable
            ...
            onLongPress={() => setSelectingCollection(!selectingCollection)}
          >
  ...
  return (
    ...
    >
        ...
        <View style={styles.articleMetaContainer}>
          <View style={{ flexDirection: "column", gap: 20 }}>
            <View style={{ flexDirection: "row", alignItems: "flex-end" }}>
              <View style={styles.metaInfoBg}>
                <Text style={styles.metaInfo}>Travel</Text>
              </View>
      ...
      <View style={styles.articleContent}>
        ...
        <View style={styles.forDemoPerpose}>
          <ImageBackground source={horse2} borderRadius={8}>
        ...
        <View
          style={{ flex: 1, flexDirection: "row", flexWrap: "wrap", gap: 10 }}
        >
      ...
      <SelectBookmarksCollections
        open={selectingCollection}
        onClose={() => {
          setSelectingCollection(false);
        }}
        onSuccess={() => {
